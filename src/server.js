 ...
 * Middleware
 */
app.use(helmet()); // for the security 
app.use(cors()); // for the cross origin source sharing when the fronten is on the browser
...
async function initializeConnection(){
    try{
        ...
        logger.info("All connections establish successfully ");
    }
    catch(error){
